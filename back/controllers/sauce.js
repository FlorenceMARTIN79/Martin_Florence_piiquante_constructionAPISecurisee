      ...
      if (!sauce.usersLiked.includes(req.body.userId) && req.body.like === 1 ) {
        Sauce.updateOne({
          ...
          .then(() => res.status(202).json({
            message: "L'utilisateur "+req.body.userId+ " like la sauce"
          }))
        ...
        .then(() => res.status(202).json({
          message: "L'utilisateur "+req.body.userId+ " dislike la sauce"
        }))
        ...
        .then(() => res.status(202).json({
          message: "L'utilisateur "+req.body.userId+ " retire son like"
        }))
        ...
        .then(() => res.status(202).json({
          message: "L'utilisateur "+req.body.userId+ " retire son dislike"
        }))
